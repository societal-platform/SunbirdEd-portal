    ...
    <#elseif section = "form">
        <#if realm.password>
            <form id="kc-form-login" class="${properties.kcFormClass!}" action="${url.loginAction}" method="post">
                <a href="/" style="float: right;margin-top: -24px;margin-right: -20px; color: #707070;" ><span class="glyphicon glyphicon-remove"></span></a>
                ...
                <div class="${properties.kcFormGroupClass!}">
                    ...
                    <div id="kc-form-buttons" class="${properties.kcFormButtonsClass!}">
                        <div class="${properties.kcFormButtonsWrapperClass!}">
                            <input class="${properties.kcButtonClass!} ${properties.kcButtonPurpleClass!}" name="login" id="kc-login" type="submit" value="${msg("doLogIn")}"/>
                        </div>
                     </div>
                </div>
            </form>
